...
- `chargeback-handler_safe.eide` — the correct design.
- `chargeback-handler_unsafe.eide` — the tempting-but-wrong version (the negative example a model must learn to reject).
