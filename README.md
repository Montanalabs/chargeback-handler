...
- `chargeback-handler_safe.os` — the correct design.
- `chargeback-handler_unsafe.os` — the tempting-but-wrong version (the negative example a model must learn to reject).
